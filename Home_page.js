...
,"awake","beat","become","begin","bend","bite","blow","break",'bring','build','burn','burst','buy','catch','come','cost','creep','cut','deal','dig','draw','dream','drink','drive','eat','fall'
,'feed','fight','find','fly','forget','forgive','freeze']
...
,'admitting', 'denying' ,'finishing','minding','recommending','appreciating','disliking','imagining','missing','resisting','avoiding','enjoying','keeping','practising','risking','considering','feeling','mentioning','preventing','suggesting'
,'going','being',"awaking","beating","becoming","begining","bending","biting","blowing","breaking",'bringing','building','burning','bursting','buying','catching','coming','costing','creeping','cutting','dealing','digging','drawing','dreaming'
,'drinking','driving','eatting','falling','feeding','fighting','finding','flying','forgetting','forgiving','freezing']
...
,"awoke","beat","became","began","bent","bit","blew","broke",'brought','built','burnt/burned','burst','bought','caught','came','cost','crept','cut','dealt','dug','drew','dreamt/dreamed','drank','drove','ate','fell','fed','fought','found'
,'flew','forgot','forgave','froze']
...
'admitted', 'denied' ,'finished','minded','recommended','appreciated','disliked','imagined','missed','resisted','avoided','enjoyed','kept','practised','risked','considered','felt','mentioned','prevented','suggested'
,'gone','been',"awoke","beaten","become","begun","bent","bitten","blown","broken",'brought','built','burnt/burned','burst','bought','caught','come','cost','crept','cut','dealt','dug','drawn','dreamt/dreamed','drunk'
,'driven','eaten','fellen','fed','fought','found','flown','forgotten','forgiven','frozen']
...
"Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","Gerunds","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result"
,"no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result","no-result"]



var translate=["同意 ( verb / 動詞 )","選擇 ( verb / 動詞 )","學習 ( verb / 動詞","繼續 ( verb / 動詞 )" ,"趨向 ( verb / 動詞 )","目的 ( verb / 動詞 )","決定 ( verb / 動詞 )"
,"需要 ( verb / 動詞 )","承諾 ( verb / 動詞 )","志願(動詞)/志願者(名詞)","問 ( verb / 動詞 )","失敗 ( verb / 動詞 )","計劃 ( 動詞 /名詞)","拒絕 ( verb / 動詞 )"
,"想 ( verb / 動詞 )","試圖 ( 動詞 / 名詞)","希望 ( 動詞 / 名詞)","準備 ( verb / 動詞 )","似乎 ( verb / 動詞 )","希望 ( verb / 動詞 )",
"承認 ( verb / 動詞 )","否定 ( verb / 動詞 )","結束 ( verb / 動詞","在乎 ( verb / 動詞 )" ,"推薦 ( verb / 動詞 )","欣賞 ( verb / 動詞 )","不喜歡 ( verb / 動詞 )"
,"想像 ( verb / 動詞 )","錯過 ( verb / 動詞 )","抵抗 ( verb / 動詞 )","避免 ( verb / 動詞 )","享受 ( verb / 動詞 )","保持 ( 動詞 /名詞)","實踐 ( verb / 動詞 )"
,"冒險(動詞)/風險(名詞)","考慮 ( verb / 動詞 )","感覺 ( verb / 動詞 )","提到 ( verb / 動詞 )","避免 ( verb / 動詞 )","建議 ( verb / 動詞 )","走 ( verb / 動詞 )"
,"是 ( 助動詞 / 動詞 )","甦醒 ( verb / 動詞 )","打 ( verb / 動詞 )","成為 ( verb / 動詞 )","開始 ( verb / 動詞 )","彎曲 ( verb / 動詞 )","咬 ( verb / 動詞 )"
,"吹 ( verb / 動詞 )","打破 ( verb / 動詞 )",'帶來 ( verb / 動詞 )','建造 ( verb / 動詞 )','燃燒 ( verb / 動詞 )','爆裂 ( verb / 動詞 )'
,'買 ( verb / 動詞 )','抓住 ( verb / 動詞 )','來 ( verb / 動詞 )','花費 ( verb / 動詞 )','爬行 ( verb / 動詞 )','切 ( verb / 動詞 )'
,'交易 ( verb / 動詞 )','挖 ( verb / 動詞 )','畫 ( verb / 動詞 )','夢 ( verb / 動詞 )','喝 ( verb / 動詞 )','駕駛 ( verb / 動詞 )'
,'吃 ( verb / 動詞 )','落下 ( verb / 動詞 )','餵養 ( verb / 動詞 )','打架 ( verb / 動詞 )','找 ( verb / 動詞 )','飛 ( verb / 動詞 )'
,'忘記 ( verb / 動詞 )','原諒 ( verb / 動詞 )','凍結 ( verb / 動詞 )']
